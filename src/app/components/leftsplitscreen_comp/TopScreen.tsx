...
const TopScreen = () => {
  return (
    <div className="flex flex-col bg-white w-full pt-4 pr-4 pl-4 pb-4 rounded-tr-2xl">
      <button className="flex flex-row p-1 w-full pl-2 pr-2 items-center rounded-sm cursor-pointer focus:bg-blue-300 transition duration-150 ease-in-out focus:outline-none">
