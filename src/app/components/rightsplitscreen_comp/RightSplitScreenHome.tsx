  ...
  return (
    <div className="bg-white overflow-x-auto flex flex-col pt-20 flex-grow w-full rounded-tl-2xl p-16 ">
      ...
      <div className="py-20">
        ...
        <Link href={`/newtask`}>
          <div className="h-full w-60 rounded-lg bg-white outline outline-1 outline-gray-300 items-center gap-2 py-3 ml-5 px-2 shadow-md hover:shadow-blue-300 cursor-pointer">
